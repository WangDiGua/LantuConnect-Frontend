...
const ADMIN_COMPONENT = {
  ...
  'performance-analysis': 'AdminMonitoringHubModule',
  'alert-management': 'AdminMonitoringHubModule',
  'alert-rules': 'AdminMonitoringHubModule',
  'health-config': 'AdminMonitoringHubModule',
  'circuit-breaker': 'AdminMonitoringHubModule',
