...
export const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center whitespace-nowrap rounded-md font-mono font-medium tracking-wider uppercase ${variantClasses} ${sizeClass} ${borderClass} ${className}`}
    >
