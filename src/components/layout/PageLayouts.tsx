...
export const MarketLayout: React.FC<BaseLayoutProps> = ({ children, className }) => (
  <div className={shellClasses(`mx-auto w-full ${contentMaxWidth} ${contentPaddingX} py-4 sm:py-5 ${sectionGap}`, className)}>
    {children}
  </div>
);
...
export const DetailLayout: React.FC<BaseLayoutProps> = ({ children, className }) => (
  <div className={shellClasses(`mx-auto w-full ${contentMaxWidth} ${contentPaddingX} py-4 sm:py-5 grid grid-cols-1 ${detailRailWidth} ${cardGap} content-start`, className)}>
    {children}
  </div>
);
