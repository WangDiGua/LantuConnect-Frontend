...
export function toolbarSearchInputClass(theme: Theme): string {
  const d = theme === 'dark';
  return `w-full pl-10 pr-4 rounded-xl border text-[13px] min-h-[2.5rem] box-border outline-none transition-all duration-200 motion-reduce:transition-none shadow-sm focus-visible:outline-none ${
    d
