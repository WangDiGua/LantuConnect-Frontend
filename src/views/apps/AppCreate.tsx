              ...
              <BentoCard theme={theme} padding="md">
                <div className="space-y-5">
                  <div>
                    ...
                    />
                    <span className={`text-xs mt-1 block ${textMuted(theme)}`}>请输入完整的 URL，以 http:// 或 https:// 开头</span>
                  ...
                  <div className={`border-t pt-5 ${isDark ? 'border-white/[0.06]' : 'border-slate-100'}`}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <select className={selectCls} value={formData.embedType} onChange={(e) => update('embedType', e.target.value as EmbedType)}>
                      ...
                      <div>
                        ...
                        <select className={selectCls} value={formData.sourceType} onChange={(e) => update('sourceType', e.target.value as SourceType)}>
