...
const HeroCodeTerminal: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="hero-code-terminal-body h-[300px] shrink-0 p-5 font-mono text-sm leading-relaxed overflow-y-auto overflow-x-hidden min-h-0 min-w-0 [scrollbar-gutter:stable]">
