...
const INITIAL_AGENTS: MyAgent[] = [
  { id: 1, displayName: '课表查询助手', description: '自动查询学期课表安排', agentType: 'http_api', status: 'published', submitTime: '2026-03-10 14:30', reviewComment: null },
  { id: 2, displayName: '图书检索 Agent', description: '接入图书馆检索 API', agentType: 'http_api', status: 'pending_review', submitTime: '2026-03-18 09:15', reviewComment: null },
  { id: 3, displayName: '教务通知推送', description: '汇总教务处通知并推送', agentType: 'mcp', status: 'draft', submitTime: '2026-03-20 16:00', reviewComment: null },
  { id: 4, displayName: '成绩分析 Agent', description: '分析学生各科成绩趋势', agentType: 'http_api', status: 'rejected', submitTime: '2026-03-15 11:00', reviewComment: '描述信息不够详细，请补充接口说明和使用场景' },
  { id: 5, displayName: '校园导航 Bot', description: '校内路线规划与导航', agentType: 'builtin', status: 'testing', submitTime: '2026-03-17 08:45', reviewComment: null },
];
