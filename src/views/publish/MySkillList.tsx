...
export const MySkillList: React.FC<Props> = ({ theme, fontSize }) => {
  ...
  const config = useMemo(() => getMyPublishListConfig('skill', navigate), [navigate]);
  return <MyResourcePublishListPage theme={theme} fontSize={fontSize} resourceType="skill" config={config} />;
};
